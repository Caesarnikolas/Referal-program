...
const secretKey =
  "7c48aaa6d93b475ab617753471cfd864270c97d4e8e5a0c8035e6cb89bed134419d6d7db10d4ad1258da8eeba7ee23ea3247d866df52aadc79ab2a42bbd1aa63";
// dbConnect();
...
app.use(
  sessions({
    ...
    store: new MongoStore({
      // выбираем в качестве хранилища файловую систему
...
app.listen(PORT, () => {
  ...
  const connectionAddress =
    ...
    "mongodb://localhost:27017/referral-program";
